...
Documentation for version *v1.4.0-rc.1*.
...
[source,python]
----
include::src/app_types/tutorial005.py[]
----
<.> {app-step1}
<.> {app-step2}
<.> {app-step3} `scheduled`.
...
[source,python]
----
include::src/app_types/tutorial006.py[]
----
<.> {app-step1}
<.> {app-step2}
<.> {app-step3} `scheduled`.
...
[source,python]
----
include::src/cache/tutorial004.py[]
----
...
[source,python]
----
include::src/cache/tutorial005.py[]
----
...
[source,python]
----
include::src/cache/tutorial006.py[]
----
...
[source,python]
----
include::src/cache/tutorial007.py[]
----
...
[source,python]
----
include::src/secrets/tutorial001.py[]
----
...
[source,python]
----
include::src/testing/tutorial005.py[]
----
<.> {test-app-step1}
<.> {test-app-step2}
<.> {test-app-step3}
...
[source,python]
----
include::src/testing/tutorial006.py[]
----
<.> {test-app-step1}
<.> {test-app-step2}
<.> {test-app-step3}
...
[source,python]
----
include::src/testing/tutorial007.py[]
----
<.> {test-app-step1}
<.> {test-app-step2}
<.> {test-app-step3}
